// Write a C++ program that performs basic arithmetic operations (addition, subtraction, multiplication, and division) on two user-provided numbers.
// The program should repeatedly prompt the user to select an operation and input two numbers, then display the result of the operation.
// The program should also handle invalid inputs gracefully and allow the user to perform multiple operations until they choose to exit.
